...
* log files are named and structured appropiately 
    * yep, but file-name is hard-coded (0.5P)
...
## Code Quality (-0.5P)
* pls don't upload your .venv, we can't download the repository in our way! 
* write the things of 'usage.txt' in the README